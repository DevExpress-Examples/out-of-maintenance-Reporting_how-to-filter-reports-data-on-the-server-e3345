...
''' 
''' Input:
'''             this.ParametersRequestSubmit += new System.EventHandler<DevExpress.XtraReports.Parameters.ParametersRequestEventArgs>(this.ProductReport_ParametersRequestSubmit)
...
'#End Region
        ...
        Private northwind1 As ServerParams.Northwind

        Private categoriesTableAdapter As ServerParams.NorthwindTableAdapters.CategoriesTableAdapter

        Private productsTableAdapter As ServerParams.NorthwindTableAdapters.ProductsTableAdapter
