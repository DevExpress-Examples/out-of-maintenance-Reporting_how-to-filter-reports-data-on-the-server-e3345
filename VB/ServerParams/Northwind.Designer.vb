...
Namespace ServerParams.NorthwindTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Public Overridable Function FillByCategoryID(ByVal dataTable As Northwind.ProductsDataTable, ByVal CategoryID? As Integer) As Integer
		...
		Public Overridable Function GetDataByCategoryID(ByVal CategoryID? As Integer) As Northwind.ProductsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			If (CategoryID.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(CategoryID.Value)))
			Else
